...
tech-stack:
  added: []
  patterns: ["motion-safe: prefix for all animations (accessibility)", "template.tsx for route-group transitions", "hover lift pattern: shadow-sm base, hover shadow-md + translate-y"]
...
- **Files modified:** src/__tests__/polish/page-fade.test.tsx, src/__tests__/polish/toast-config.test.tsx
